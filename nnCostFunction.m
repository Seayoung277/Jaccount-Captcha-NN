...
for i = 1:m
	...
	a_3(i, :) = sigmoid(z_3(i, :))';
	J = J - Y(i, :) * log(a_3(i, :)') - (ones(1, num_labels) - Y(i, :)) * log(ones(num_labels, 1) - a_3(i, :)');
end
...
for i = 1:m
	d_3(i, :) = a_3(i, :) - Y(i, :);
	d_2(i, :) = (Theta2(:, 2:end)' * d_3(i, :)' .* sigmoidGradient(z_2(i, :)'))';
	Theta1_grad = Theta1_grad + d_2(i, :)' * [1.0 X(i, :)];
	Theta2_grad = Theta2_grad + d_3(i, :)' * [1.0 a_2(i, :)];
end
